    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            var p1, p2, input;
                ...
                p1 = this.createEls('p', {}, 'Kéo và thả ảnh vào đây,');
                p2 = this.createEls('p', {}, 'hoặc nhấn vào đây để tải ảnh lên.');
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: './css/loading-spin-1.svg'});
